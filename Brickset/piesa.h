...
public:
    ...
    virtual void add_conector(conector conector) = 0;
    virtual const std::vector<conector>& get_conectori() const = 0;
...
public:
    ...
    void add_conector(conector conector) override;
    const std::vector<conector>& get_conectori() const override;
